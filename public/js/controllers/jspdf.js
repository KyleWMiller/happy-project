(function() {
    ...
    function pdfController(poFactory,pdfFactory) {
      ...
      pdf.pdfSelect = function(item, yStart) {
        switch(item) {
          case "SDR":
          // SDR - 140 starting y value
              var y = yStart,
                  qty = 1,
                  price = 28875.00,
                  total = price * qty,
                  ...
                  line6 = pl.text(17, y += 5, "MPN: " + mpn),
                  line7 = pl.text(17, y += 5, "S/N: " + sn),
                  line8 = pl.text(17, y += 5, "SIM/Configuration module pre-installed")

              return line1 && line2 && line3 && line4 && line5 && line6 && line7 && line8 && y
              break
          case "Mounting Plate":
              var y = yStart,
                  qty = 1,
