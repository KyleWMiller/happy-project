(function() {
  ...
  angular.module('jsPDF', [])
    .controller('pdfController', ['poFactory', 'pdfFactory', '$stateParams', '$filter', '$state', pdfController])


  function pdfController(poFactory, pdfFactory, $stateParams, $filter, $state) {
    var pdf = this
